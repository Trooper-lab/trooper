/**
 * Lazy Project Configuration
 * 
 * WHY: This file encapsulates all branding and metadata for the 'Laazy' project.
 * Keeping it separate prevents conflicts with other project data.
 */
