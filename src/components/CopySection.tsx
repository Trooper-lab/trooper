...
export function CopySection() {
    return (
        <section className="w-full text-left py-14 md:py-24 px-6 md:px-12 bg-[#F2F2F2] flex flex-col items-start">
            <h2 className="font-sans text-[32px] md:text-[48px] font-medium mb-[24px] leading-[1.1] max-w-4xl tracking-tighter">
                We build the cool stuff. <br />
                You keep the remote.
            </h2>
            <p className="font-sans text-[17px] md:text-[24px] text-foreground/70 max-w-2xl mb-[48px] tracking-tight leading-relaxed">
